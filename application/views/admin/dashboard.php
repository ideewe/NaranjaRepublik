...
<body>
    ...
    <div class="wrapper  theme-1-active pimary-color-blue">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="mobile-only-brand pull-left">
				<div class="nav-header pull-left">
					<div class="logo-wrap">
						<a href="index.html">							
							<img  src="<?= base_url()?>assets/img/NR.png"  height="54" width="200" alt="brand"/>							
						</a>
					</div>
				</div>	
		...
		<div class="page-wrapper">
										...
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
													<span class="txt-dark block counter"><span class="counter-anim">9,001</span></span>
													<span class="weight-500 uppercase-font block font-13">Registrados</span>
												</div>
										...
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
													...
													<span class="weight-500 uppercase-font block">Personas Registradas</span>
												</div>
												<div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                       ...
                       <div class="panel panel-default card-view panel-refresh">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									...
									<div class="label-chatrs">
										<div class="">
											<span class="clabels clabels-lg inline-block bg-warning mr-10 pull-left"></span>
						...
						<div class="panel panel-default card-view">
							<div class="panel-wrapper collapse in">
                                <div class="panel-body sm-data-box-1">
									<span class="uppercase-font weight-600 font-14 block text-center txt-dark">customer satisfaction</span>	
			...
			<footer class="footer container-fluid pl-30 pr-30">
				<div class="row">
					<div class="col-sm-12">
						<p>2019 &copy; Naranja Republik. Cuidadosamente diseñado por ideewe</p>
					</div>
				</div>
			</footer>
			<!-- /Footer -->
	...
	<script src="<?= base_url()?>assets/dist/js/jquery.waypoints.min.js"></script>
	...
	<script src="<?= base_url()?>assets/dist/js/jquery.sparkline.min.js"></script>
	
	<!-- Owl JavaScript -->
	<script src="<?= base_url()?>assets/dist/js/owl.carousel.min.js"></script>
	
	<!-- Switchery JavaScript -->
	<script src="<?= base_url()?>assets/dist/js/switchery.min.js"></script>
	
	<!-- EChartJS JavaScript -->
	<script src="<?= base_url()?>assets/dist/js/echarts-en.min.js"></script>
	<script src="<?= base_url()?>assets/dist/js/echarts-liquidfill.min.js"></script>
	
	<!-- Toast JavaScript -->
	<script src="<?= base_url()?>assets/dist/js/jquery.toast.min.js"></script>
